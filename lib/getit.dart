...
class GetItInitializer {
  ...
  SerialIdDb? _serialIdDb;
  set serialIdDb(SerialIdDb serialIdDb) => _serialIdDb = serialIdDb;
  ...
  void init() => GetIt.I
    ...
    ..registerSingleton<SerialIdDb>(
        _serialIdDb ?? SerialIdDb(_sharedPreferences))
