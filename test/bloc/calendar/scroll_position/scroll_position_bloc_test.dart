...
void main() {
  ...
  test(
    ...
    final expect = expectLater(scrollPositionBloc.stream, emits(Unready()));
    // Act
    scrollPositionBloc.scrollViewRenderComplete(mockScrollController);
  ...
  test(
    ...
    () async {
      ...
      for (var i = activityAt; i < max; i++) {
        ...
        scrollPositionBloc.scrollPositionUpdated();
      }
