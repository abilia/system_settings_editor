...
void main() {
  ...
  test('Parse correct body information', () {
    final testBodyStringCorrect = "{\"status\":403,\"message\":\"Clients can only be registered with entities of type 'user'\",\"errorId\":217,\"errors\":[{\"code\":\"WHALE-0156\",\"message\":\"Clients can only be registered with entities of type 'user'\"}]}";
  ...
  test('Parse body with no errors', () {
    final testBodyStringNoErrors = "{\"status\":403,\"message\":\"Clients can only be registered with entities of type 'user'\",\"errorId\":218,\"errors\":[]}";
